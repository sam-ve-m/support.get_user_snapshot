#!/bin/bash
fission spec init
fission env create --spec --name get-user-snapshot-env --image nexus.sigame.com.br/python-env-3.8:0.0.5 --builder nexus.sigame.com.br/fission-builder-3.8:0.0.1
